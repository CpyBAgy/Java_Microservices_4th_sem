...
public class CatController {
    ...
    @GetMapping("/equals")
    public List<CatDTO> getCatsWithFilterEquals(@RequestParam(value = "name", required = false) String name,
                                                @RequestParam(value = "color", required = false) Color color,
                                                @RequestParam(value = "breed", required = false) String breed) {
        return service.findCatsWithFilter(CatFilterManager.manage(name, color, breed, FilteringType.EQUALS));
    }
    ...
    public List<CatDTO> getSimilarCatsWithFilter(@RequestParam(value = "name", required = false) String name,
                                                 @RequestParam(value = "color", required = false) Color color,
                                                 @RequestParam(value = "breed", required = false) String breed) {
        return service.findCatsWithFilter(CatFilterManager.manage(name, color, breed, FilteringType.LIKE));
    }
