...
public class CatService implements ICatService {
    ...
    public CatDTO getCatById(Integer id) {
        ...
        return new CatDTO(cat.getId(), cat.getName(), cat.getBreed(), cat.getColor(), cat.getBirthday(), null, new ArrayList<>());
    }
    ...
    public List<CatDTO> findCatsWithFilter(List<Filter> filters) {
        ...
        return cats.stream()
                .map(cat -> new CatDTO(cat.getId(), cat.getName(), cat.getBreed(), cat.getColor(), cat.getBirthday(), null, new ArrayList<>()))
